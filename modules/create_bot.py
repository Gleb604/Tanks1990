...
class Bot(m_hero.My_hero):
    def __init__(self, width2 = 32, height2 = 32, x2 = 0, y2 = 0, name_file2 = None, sound2 = False, folder_img2 = None, type_bot = None, fire_rate = None, speed_bot = None):
        m_hero.My_hero.__init__(self, width1 = width2, height1 = height2, x1= x2, y1 = y2, name_file1= name_file2, sound1= sound2, folder_img1= folder_img2)
...
bot3 = Bot(name_file2 = "images/bot/bot3/tank_UP_DW_1.png", folder_img2= "bot/bot3", type_bot = "bot3", x2= 256, y2= 0, fire_rate= 150, speed_bot= 0.5)
